...
public class IntBoardTests {
	...
	public void testAdjTopLeftCorner() {
		/*
		 * Since we are at the top corner, we can only be adjacent to two squares
		 * right and down*/
	...
	public void testAdjRightEdge() {
		/*
		 * Since we are at right edge we can be adjacent to 3 squares
		 * right, left, and up*/
	...
	public void testAdjLeftEdge() {
		/*
		 * Since we are at left edge we can be adjacent to 2 squares
		 * left, and down*/
	...
	public void testTargetRoll5() {
		/*
		 * If we roll a 5*/
		BoardCell cell = board.getCell(2, 2); // different point
		board.calcTargets(cell, 4);
		Set<BoardCell> targets = board.getTargets();
